...
and page_id in (select cla.cl_from from categorylinks cla inner join linktarget lt ON cla.cl_target_id = lt.lt_id where lt.lt_title like "جميع_المقالات_غير_المراجعة" and lt.lt_namespace = 14);"""
