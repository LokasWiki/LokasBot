...
ORDER BY COUNT(*) DESC
LIMIT 500;"""
file_path = 'stub/users_by_number_of_redirect_creation_with_bot.txt'
page_name = "ويكيبيديا:تقارير قاعدة البيانات/المستخدمين حسب عدد إنشاء التحويلات (متضمنة البوتات)"
...
columns = [
    ...
    ("عدد التحويلات", None, total_edits),
]
