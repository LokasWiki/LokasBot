...
ORDER BY COUNT(*) DESC
LIMIT 500;"""
file_path = 'stub/users_by_number_of_article_creation_with_bot.txt'
page_name = "ويكيبيديا:تقارير قاعدة البيانات/المستخدمين حسب عدد إنشاء المقالات (متضمنة البوتات)"
